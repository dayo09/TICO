...
class TestRegisterStaticCache(unittest.TestCase):
    ...
    def _make_cache(self):
        ...
        if Version(transformers.__version__) < Version("4.50.0"):
            self.skipTest("StaticCache with layers API requires transformers >= 4.50.0")
...
class TestRegisterStaticLayer(unittest.TestCase):
    ...
    def _make_layer(self):
        ...
        if Version(transformers.__version__) < Version("4.50.0"):
            self.skipTest("StaticLayer requires transformers >= 4.50.0")
    ...
    def test_roundtrip_metadata_preserved(self):
        ...
        self.assertEqual(restored.k_head_dim, layer.k_head_dim)
        self.assertEqual(restored.v_head_dim, layer.v_head_dim)
...
class TestRegisterDynamicLayer(unittest.TestCase):
    ...
    def _make_layer(self):
        ...
        if Version(transformers.__version__) < Version("4.50.0"):
            self.skipTest("DynamicLayer requires transformers >= 4.50.0")
...
class TestRegisterEncoderDecoderCache(unittest.TestCase):
    ...
    def _make_cache(self):
        ...
        if Version(transformers.__version__) < Version("4.50.0"):
            self.skipTest(
                "EncoderDecoderCache with Layer-based internals requires transformers >= 4.50.0"
            )
